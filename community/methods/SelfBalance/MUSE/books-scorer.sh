#!/bin/bash
# SelfBalancing GradDiff + LearnedScorer — MUSE Books Train & Eval
...
########################################
# 2. MUSE EVALUATION (UNLEARNED)
########################################
# echo ""
# echo "=================================================="
# echo " MUSE Eval — ${complete_name}"
# echo "=================================================="
...
#     +model.tokenizer_args.token=$HF_TOKEN \
#     ++model.model_args.device_map='auto' \
#     paths.output_dir=$(pwd)/saves/unlearn/${complete_name}/muse_evals
