...
ScoredGradDiff_lr=${ScoredGradDiff_lr:-$(get_param ScoredGradDiff lr)}
ScoredGradDiff_gamma=${ScoredGradDiff_gamma:-$(get_param ScoredGradDiff gamma)}
ScoredGradDiff_alpha=${ScoredGradDiff_alpha:-$(get_param ScoredGradDiff alpha)}

task_name="SB_TOFU/${model}/forget10/ScoredGradDiff"
...
echo ""
echo "============================================"
echo " ScoredGradDiff — Unlearn (forget10)"
echo "============================================"
...
HYDRA_FULL_ERROR=1 \
    ...
    trainer.args.learning_rate=$ScoredGradDiff_lr \
    trainer.method_args.gamma=$ScoredGradDiff_gamma \
    trainer.method_args.alpha=$ScoredGradDiff_alpha \
