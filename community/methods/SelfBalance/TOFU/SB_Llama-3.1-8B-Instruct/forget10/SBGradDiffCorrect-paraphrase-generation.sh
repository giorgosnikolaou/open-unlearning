...
# Model: Llama-3.1-8B-Instruct | Split: forget10 | Method: SBGradDiffCorrect
...
task_name="SB_TOFU/${model}/forget10/SBGradDiffCorrect"
model_output="saves/unlearn/${task_name}"

echo ""
echo "============================================"
echo " SBGradDiffCorrect — Paraphrase Generation (forget10)"
echo "============================================"
