...
# Model: Llama-3.1-8B-Instruct | Split: forget05 | Method: SBGradDiffCorrect
...
task_name="SB_TOFU/${model}/forget05/SBGradDiffCorrect"
model_output="saves/unlearn/${task_name}"

echo ""
echo "============================================"
echo " SBGradDiffCorrect — Paraphrase Generation (forget05)"
echo "============================================"
