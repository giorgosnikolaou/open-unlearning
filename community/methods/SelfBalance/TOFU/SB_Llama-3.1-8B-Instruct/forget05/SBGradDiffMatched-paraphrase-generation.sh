...
# Model: Llama-3.1-8B-Instruct | Split: forget05 | Method: SBGradDiffMatched
...
task_name="SB_TOFU/${model}/forget05/SBGradDiffMatched"
model_output="saves/unlearn/${task_name}"

echo ""
echo "============================================"
echo " SBGradDiffMatched — Paraphrase Generation (forget05)"
echo "============================================"
