...
# Model: Llama-3.1-8B-Instruct | Split: forget01 | Method: SBNPOMatched
...
task_name="AUG_TOFU/${model}/forget01/SBNPOMatched"
model_output="saves/unlearn/${task_name}"

echo ""
echo "============================================"
echo " SBNPOMatched — Paraphrase Generation (forget01)"
echo "============================================"
