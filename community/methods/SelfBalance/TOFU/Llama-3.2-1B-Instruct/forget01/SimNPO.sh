#!/bin/bash
# SimNPO — Unlearn + Eval (TOFU + Paraphrase)
...
SIMNPO_lr=${SIMNPO_lr:-$(get_param SimNPO lr)}
SIMNPO_gamma=${SIMNPO_gamma:-$(get_param SimNPO gamma)}
SIMNPO_alpha=${SIMNPO_alpha:-$(get_param SimNPO alpha)}
SIMNPO_beta=${SIMNPO_beta:-$(get_param SimNPO beta)}
SIMNPO_delta=${SIMNPO_delta:-$(get_param SimNPO delta)}

task_name="SB_TOFU/${model}/${forget_split}/SimNPO"
...
echo ""
echo "============================================"
echo " SimNPO — Unlearn (${forget_split})"
echo "============================================"
...
HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=$GPU \
    ...
    trainer.args.learning_rate=$SIMNPO_lr \
...
# echo ""
# echo "============================================"
# echo " SimNPO — TOFU Eval (${forget_split})"
# echo "============================================"
...
# echo ""
# echo "============================================"
# echo " SimNPO — Paraphrase Eval (${forget_split})"
# echo "============================================"
