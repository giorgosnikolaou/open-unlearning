#!/bin/bash
# NPO — Unlearn + Eval (TOFU + Paraphrase)
...
NPO_lr=${NPO_lr:-$(get_param NPO lr)}
NPO_gamma=${NPO_gamma:-$(get_param NPO gamma)}
NPO_alpha=${NPO_alpha:-$(get_param NPO alpha)}
NPO_beta=${NPO_beta:-$(get_param NPO beta)}
...
HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=$GPU \
    ...
    trainer.args.learning_rate=$NPO_lr \
...
# echo ""
# echo "============================================"
# echo " NPO — TOFU Eval (${forget_split})"
# echo "============================================"
...
# echo ""
# echo "============================================"
# echo " NPO — Paraphrase Eval (${forget_split})"
# echo "============================================"
