#!/bin/bash
# Paraphrase Generation — GPU phase (Baseline)
# Model: Llama-3.2-1B-Instruct | Split: forget05 | Baseline: retain95
...
task_name="SB_TOFU/${model}/baselines/retain95_${forget_split}"
model_path="open-unlearning/tofu_${model}_retain95"

echo ""
echo "============================================"
echo " retain95 — Paraphrase Generation (${forget_split})"
echo "============================================"
...
HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=$GPU \
    ...
    eval.paraphrase.metrics.forget_quality.max_samples=200 \
