#!/bin/bash
# WGA — Unlearn + Eval (TOFU + Paraphrase)
...
WGA_lr=${WGA_lr:-$(get_param WGA lr)}
WGA_gamma=${WGA_gamma:-$(get_param WGA gamma)}
WGA_alpha=${WGA_alpha:-$(get_param WGA alpha)}
WGA_beta=${WGA_beta:-$(get_param WGA beta)}

task_name="SB_TOFU/${model}/${forget_split}/WGA"
...
HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=$GPU \
    ...
    trainer.args.learning_rate=$WGA_lr \
    trainer.method_args.gamma=$WGA_gamma \
    trainer.method_args.alpha=$WGA_alpha \
    trainer.method_args.beta=$WGA_beta
...
# echo ""
# echo "============================================"
# echo " WGA — TOFU Eval (${forget_split})"
# echo "============================================"
...
# echo ""
# echo "============================================"
# echo " WGA — Paraphrase Eval (${forget_split})"
# echo "============================================"
