#!/bin/bash
# DPO — Unlearn + Eval (TOFU + Paraphrase)
...
DPO_lr=${DPO_lr:-$(get_param DPO lr)}
DPO_gamma=${DPO_gamma:-$(get_param DPO gamma)}
DPO_alpha=${DPO_alpha:-$(get_param DPO alpha)}
DPO_beta=${DPO_beta:-$(get_param DPO beta)}

task_name="SB_TOFU/${model}/${forget_split}/DPO"
...
HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=$GPU \
    ...
    trainer.args.learning_rate=$DPO_lr \
    trainer.method_args.gamma=$DPO_gamma \
    trainer.method_args.alpha=$DPO_alpha \
    trainer.method_args.beta=$DPO_beta \
    model=$model
...
# echo ""
# echo "============================================"
# echo " DPO — TOFU Eval (${forget_split})"
# echo "============================================"
...
# echo ""
# echo "============================================"
# echo " DPO — Paraphrase Eval (${forget_split})"
# echo "============================================"
