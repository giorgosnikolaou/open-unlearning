...
# Model: Llama-3.2-1B-Instruct | Split: forget01 | Method: SBGradDiffCorrectMatched
...
task_name="SB_TOFU/${model}/forget01/SBGradDiffCorrectMatched"
model_output="saves/unlearn/${task_name}"

echo ""
echo "============================================"
echo " SBGradDiffCorrectMatched — Paraphrase Generation (forget01)"
echo "============================================"
