...
SBSimNPO_lr=${SBSimNPO_lr:-$(get_param SBSimNPO lr)}
SBSimNPO_gamma=${SBSimNPO_gamma:-$(get_param SBSimNPO gamma)}
SBSimNPO_alpha=${SBSimNPO_alpha:-$(get_param SBSimNPO alpha)}
SBSimNPO_beta=${SBSimNPO_beta:-$(get_param SBSimNPO beta)}
SBSimNPO_delta=${SBSimNPO_delta:-$(get_param SBSimNPO delta)}
SBSimNPO_scorer_lr=${SBSimNPO_scorer_lr:-$(get_param SBSimNPO scorer_lr)}

task_name="SB_TOFU/${model}/forget01/SBSimNPO"
...
echo ""
echo "============================================"
echo " SBSimNPO — Unlearn (forget01)"
echo "============================================"
...
HYDRA_FULL_ERROR=1 \
    ...
    trainer.args.learning_rate=$SBSimNPO_lr \
    trainer.method_args.gamma=$SBSimNPO_gamma \
    trainer.method_args.alpha=$SBSimNPO_alpha \
    trainer.method_args.beta=$SBSimNPO_beta \
    trainer.method_args.delta=$SBSimNPO_delta \
    ...
    trainer.method_args.scorer_trainer.optim_cfg.lr=$SBSimNPO_scorer_lr \
