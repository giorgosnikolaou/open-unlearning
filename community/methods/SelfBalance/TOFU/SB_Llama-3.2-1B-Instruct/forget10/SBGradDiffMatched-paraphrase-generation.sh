...
# Model: Llama-3.2-1B-Instruct | Split: forget10 | Method: SBGradDiffMatched
...
task_name="SB_TOFU/${model}/forget10/SBGradDiffMatched${TASK_SUFFIX}"
model_output="saves/unlearn/${task_name}"

echo ""
echo "============================================"
echo " SBGradDiffMatched — Paraphrase Generation (forget10)"
echo "============================================"
