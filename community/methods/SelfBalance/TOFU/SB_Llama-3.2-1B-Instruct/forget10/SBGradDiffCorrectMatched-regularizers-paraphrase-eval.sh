#!/bin/bash
# SBGradDiffCorrectMatched — Regularizer ablation: Paraphrase Eval (API judging)
# Model: Llama-3.2-1B-Instruct | Split: forget10
# Loops over 8 = 2^3 combinations of (ent, pop, l2) and runs the judging phase
...
for ent in 0 1; do
  for pop in 0 1; do
    for l2 in 0 1; do
      ...
      echo ""
      echo "============================================"
      echo " SBGradDiffCorrectMatched — regs ${tag} — Paraphrase Judging"
      echo "============================================"
