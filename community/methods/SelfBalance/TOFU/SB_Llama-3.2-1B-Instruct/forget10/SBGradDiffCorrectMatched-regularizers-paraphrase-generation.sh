#!/bin/bash
# SBGradDiffCorrectMatched — Regularizer ablation: Paraphrase Generation
# Model: Llama-3.2-1B-Instruct | Split: forget10
# Loops over 8 = 2^3 combinations of (ent, pop, l2) and runs paraphrase generation
# for each /regs/E${ent}_P${pop}_L${l2}/ subdir.
...
for ent in 0 1; do
  for pop in 0 1; do
    for l2 in 0 1; do
      ...
      task_name="SB_TOFU/${model}/forget10/SBGradDiffCorrectMatched/regs/${tag}"
      model_output="saves/unlearn/${task_name}"

      echo ""
      echo "============================================"
      echo " SBGradDiffCorrectMatched — regs ${tag} — Paraphrase Generation"
      echo "============================================"
