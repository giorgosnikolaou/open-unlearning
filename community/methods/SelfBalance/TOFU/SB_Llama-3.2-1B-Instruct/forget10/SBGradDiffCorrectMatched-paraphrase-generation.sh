...
# Model: Llama-3.2-1B-Instruct | Split: forget10 | Method: SBGradDiffCorrectMatched
...
task_name="SB_TOFU/${model}/forget10/SBGradDiffCorrectMatched${TASK_SUFFIX}"
model_output="saves/unlearn/${task_name}"

echo ""
echo "============================================"
echo " SBGradDiffCorrectMatched — Paraphrase Generation (forget10)"
echo "============================================"
