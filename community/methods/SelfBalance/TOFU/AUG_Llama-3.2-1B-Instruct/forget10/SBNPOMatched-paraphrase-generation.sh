...
# Model: Llama-3.2-1B-Instruct | Split: forget10 | Method: SBNPOMatched
...
task_name="AUG_TOFU/${model}/forget10/SBNPOMatched"
model_output="saves/unlearn/${task_name}"

echo ""
echo "============================================"
echo " SBNPOMatched — Paraphrase Generation (forget10)"
echo "============================================"
