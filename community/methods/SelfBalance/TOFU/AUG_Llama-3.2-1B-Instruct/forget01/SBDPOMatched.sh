...
SBDPOMatched_lr=${SBDPOMatched_lr:-$(get_param SBDPOMatched lr)}
SBDPOMatched_gamma=${SBDPOMatched_gamma:-$(get_param SBDPOMatched gamma)}
SBDPOMatched_alpha=${SBDPOMatched_alpha:-$(get_param SBDPOMatched alpha)}
SBDPOMatched_beta=${SBDPOMatched_beta:-$(get_param SBDPOMatched beta)}
SBDPOMatched_scorer_lr=${SBDPOMatched_scorer_lr:-$(get_param SBDPOMatched scorer_lr)}

task_name="AUG_TOFU/${model}/forget01/SBDPOMatched"
...
echo ""
echo "============================================"
echo " SBDPOMatched — Unlearn (forget01)"
echo "============================================"
...
HYDRA_FULL_ERROR=1 \
    ...
    trainer.args.learning_rate=$SBDPOMatched_lr \
    trainer.method_args.gamma=$SBDPOMatched_gamma \
    trainer.method_args.alpha=$SBDPOMatched_alpha \
    trainer.method_args.beta=$SBDPOMatched_beta \
    ...
    trainer.method_args.scorer_trainer.optim_cfg.lr=$SBDPOMatched_scorer_lr \
