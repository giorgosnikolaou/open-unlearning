...
# Model: Llama-3.2-1B-Instruct | Split: forget01 | Method: SBWGAMatched
...
task_name="AUG_TOFU/${model}/forget01/SBWGAMatched"
model_output="saves/unlearn/${task_name}"

echo ""
echo "============================================"
echo " SBWGAMatched — Paraphrase Generation (forget01)"
echo "============================================"
