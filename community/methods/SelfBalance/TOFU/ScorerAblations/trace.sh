#!/bin/bash
# Scorer (original SelfBalancingGradDiff) — Ablation: trace scorer through training
# Saves scorer at init, every 10 model steps, and at the end.
...
task_name="SB_TOFU/${model}/forget10/ScorerAblations/trace"
...
echo ""
echo "============================================"
echo " Scorer Ablation: trace — Unlearn (forget10)"
echo "============================================"
...
HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=$GPU \
    ...
    trainer.method_args.scorer_pretrain.scorer_save_every_steps=$save_every_steps
...
echo ""
echo "============================================"
echo " trace — Paraphrase Generation (forget10)"
echo "============================================"
...
echo ""
echo "============================================"
echo " trace — Paraphrase Judging (forget10)"
echo "============================================"
