#!/bin/bash
# Scorer Ablation: regularizers — Paraphrase Generation (ONE config per invocation)
#
# Usage:
#   bash regularizers-paraphrase-generation.sh ENT POP L2     # positional, each 0 or 1
#   ENT=1 POP=0 L2=1 bash regularizers-paraphrase-generation.sh
...
echo ""
echo "============================================"
echo " Scorer Ablation: regularizers ${tag} — Paraphrase Generation"
echo "============================================"
