#!/bin/bash
# Scorer Ablation: update-frequency — Paraphrase Judging (API, no GPU; ONE config per invocation)
#
# Usage:
#   bash update-frequency-paraphrase-eval.sh UEV     # positional (positive int)
#   UEV=5 bash update-frequency-paraphrase-eval.sh
...
echo ""
echo "============================================"
echo " Scorer Ablation: update-frequency uev=${UEV} — Paraphrase Judging"
echo "============================================"
