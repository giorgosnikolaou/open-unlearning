#!/bin/bash
# Scorer Ablation: joint — scorer params optimized via main loss (single backward pass).
# Uses SBGradDiffMatchedJoint config (NoOpScorerTrainer; the joint paradigm has no
# matched/non-matched distinction since it doesn't use a separate scorer trainer).
...
HP_KEY="${HP_KEY:-SBGradDiffMatchedJoint}"
...
task_name="SB_TOFU/${model}/forget10/ScorerAblations/joint"
...
echo ""
echo "============================================"
echo " Scorer Ablation: joint — Unlearn (forget10)"
echo "============================================"
...
echo ""
echo "============================================"
echo " joint — Paraphrase Generation (forget10)"
echo "============================================"
...
echo ""
echo "============================================"
echo " joint — Paraphrase Judging (forget10)"
echo "============================================"
