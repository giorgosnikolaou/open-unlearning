...
# for 1 epoch on the original model, freeze it, then unlearn the model.
...
task_name="SB_TOFU/${model}/forget10/ScorerAblations/pretrain-frozen"
...
echo ""
echo "============================================"
echo " Scorer Ablation: pretrain-frozen — Unlearn (forget10)"
echo "============================================"
...
echo ""
echo "============================================"
echo " pretrain-frozen — Paraphrase Generation (forget10)"
echo "============================================"
...
echo ""
echo "============================================"
echo " pretrain-frozen — Paraphrase Judging (forget10)"
echo "============================================"
