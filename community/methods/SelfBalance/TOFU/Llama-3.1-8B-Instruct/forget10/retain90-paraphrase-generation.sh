...
# Model: Llama-3.1-8B-Instruct | Split: forget10 | Baseline: retain90
...
task_name="SB_TOFU/${model}/baselines/retain90_${forget_split}"
model_path="open-unlearning/tofu_${model}_retain90"

echo ""
echo "============================================"
echo " retain90 — Paraphrase Generation (${forget_split})"
echo "============================================"
