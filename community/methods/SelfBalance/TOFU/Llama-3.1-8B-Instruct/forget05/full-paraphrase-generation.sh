...
# Model: Llama-3.1-8B-Instruct | Split: forget05 | Baseline: full
...
task_name="SB_TOFU/${model}/baselines/full_${forget_split}"
model_path="open-unlearning/tofu_${model}_full"

echo ""
echo "============================================"
echo " full — Paraphrase Generation (${forget_split})"
echo "============================================"
