#!/bin/bash
# SelfBalancing GradDiff + TIDPOScorer — TOFU Paraphrase Train & Eval
...
params="lam${lam}_pmean${prior_mean}_pstd${prior_std}"
prefix="TIDPO/beta5_"
prefix="TIDPO/no_beta_"
...
###################
echo "==========================================="
echo " TIDPOScorer — ${complete_name}"
echo "==========================================="
