#!/bin/bash
# Paraphrase judging for SBGradDiffScored checkpoint.
# Usage: bash SBGradDiffScored-paraphrase-eval.sh [trial_name]  (default: trial_8_lr1_22e-06)
...
echo ""
echo "============================================"
echo " Paraphrase Evaluation: SBGradDiffScored"
echo "============================================"
