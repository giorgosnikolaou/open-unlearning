#!/bin/bash
# Paraphrase generation for SatImp checkpoint.
# Usage: bash SatImp-paraphrase-gen.sh [trial_name]  (default: trial_0_lr1_98e-06)
...
echo ""
echo "============================================"
echo " Paraphrase Generation: SatImp"
echo "============================================"
...
HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=0 \
    ...
    paths.output_dir=$(pwd)/saves/unlearn/RWKU/Optimal/SatImp/paraphrase_evals
