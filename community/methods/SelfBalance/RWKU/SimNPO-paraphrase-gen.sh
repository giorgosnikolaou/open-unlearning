#!/bin/bash
# Paraphrase generation for SimNPO checkpoint.
# Usage: bash SimNPO-paraphrase-gen.sh [trial_name]  (default: trial_0_lr2_08e-05)
...
echo ""
echo "============================================"
echo " Paraphrase Generation: SimNPO"
echo "============================================"
...
HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=0 \
    ...
    paths.output_dir=$(pwd)/saves/unlearn/RWKU/Optimal/SimNPO/paraphrase_evals
