#!/bin/bash
# Evaluate SBWGA checkpoint on RWKU benchmark.
# Usage: bash SBWGA.sh [trial_name]  (default: trial_0)
...
HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=0 \
    ...
    paths.output_dir=$(pwd)/saves/unlearn/RWKU/Optimal/SBWGA/rwku_evals
...
# echo ""
# echo "============================================"
# echo " RWKU Utility Evaluation: SBWGA"
# echo "============================================"
#
# HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=0 \
#     python src/eval.py \
...
#     ++model.model_args.device_map='auto' \
#     '~eval.rwku' \
#     paths.output_dir=$(pwd)/saves/unlearn/RWKU/Optimal/SBWGA/rwku_utility_evals
