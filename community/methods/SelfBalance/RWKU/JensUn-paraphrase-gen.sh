#!/bin/bash
# Paraphrase generation for JensUn checkpoint.
# Usage: bash JensUn-paraphrase-gen.sh [trial_name]  (default: trial_1_lr1_18e-06)
...
echo ""
echo "============================================"
echo " Paraphrase Generation: JensUn"
echo "============================================"
...
HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=0 \
    ...
    paths.output_dir=$(pwd)/saves/unlearn/RWKU/Optimal/JensUn/paraphrase_evals
