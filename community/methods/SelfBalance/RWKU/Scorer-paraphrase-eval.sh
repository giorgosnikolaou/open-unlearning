#!/bin/bash
# Paraphrase judging for Scorer (GradDiffScored) checkpoint.
# Usage: bash Scorer-paraphrase-eval.sh [trial_name]  (default: trial_1_lr5_00e-06)
...
echo ""
echo "============================================"
echo " Paraphrase Evaluation: Scorer"
echo "============================================"
