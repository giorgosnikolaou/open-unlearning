#!/bin/bash
# Evaluate SBGradDiffScoredCorrect checkpoint on RWKU benchmark.
# Usage: bash SBGradDiffScoredCorrect.sh [trial_name]  (default: trial_0_lr2_60e-06)
...
echo ""
echo "============================================"
echo " RWKU Evaluation: SBGradDiffScoredCorrect"
echo "============================================"
...
HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=0 \
    ...
    paths.output_dir=$(pwd)/saves/unlearn/RWKU/Optimal/SBGradDiffScoredCorrect/rwku_evals
...
# echo ""
# echo "============================================"
# echo " RWKU Utility Evaluation: SBGradDiffScoredCorrect"
# echo "============================================"
#
# HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=0 \
#     python src/eval.py \
...
#     ++model.model_args.device_map='auto' \
#     '~eval.rwku' \
#     paths.output_dir=$(pwd)/saves/unlearn/RWKU/Optimal/SBGradDiffScoredCorrect/rwku_utility_evals