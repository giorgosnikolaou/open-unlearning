#!/bin/bash
# Paraphrase judging for GradDiff checkpoint.
# Usage: bash GradDiff-paraphrase-eval.sh [trial_name]  (default: trial_1_lr1_18e-06)
...
echo ""
echo "============================================"
echo " Paraphrase Evaluation: GradDiff"
echo "============================================"
