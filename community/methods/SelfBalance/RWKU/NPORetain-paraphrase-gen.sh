#!/bin/bash
# Paraphrase generation for NPORetain checkpoint.
# Usage: bash NPORetain-paraphrase-gen.sh [trial_name]  (default: trial_3_lr1_18e-05)
...
echo ""
echo "============================================"
echo " Paraphrase Generation: NPORetain"
echo "============================================"
...
HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=0 \
    ...
    paths.output_dir=$(pwd)/saves/unlearn/RWKU/Optimal/NPORetain/paraphrase_evals
