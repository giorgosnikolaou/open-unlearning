#!/bin/bash
# Paraphrase generation for SBNPO checkpoint.
# Usage: bash SBNPO-paraphrase-gen.sh [trial_name]  (default: trial_0)
...
echo ""
echo "============================================"
echo " Paraphrase Generation: SBNPO"
echo "============================================"
...
HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=0 \
    ...
    paths.output_dir=$(pwd)/saves/unlearn/RWKU/Optimal/SBNPO/paraphrase_evals
