...
experiment="unlearn/rwku/prompted.yaml"
...
prefix="PromptedRWKU/Llama3.2-1B/${max_length}/beta0.5_${num_train_epochs}_${scorer_lr}_${scorer_grad_clip}_${normalize_hidden}_"
prefix="PromptedRWKU/Llama3.2-1B/${max_length}/beta5_${num_train_epochs}_${scorer_lr}_${scorer_grad_clip}_${normalize_hidden}_"
prefix="PromptedRWKU/Llama3.2-1B/${max_length}/beta2_${num_train_epochs}_${scorer_lr}_${scorer_grad_clip}_${normalize_hidden}_"
# prefix="PromptedRWKU/Llama3.2-1B/${max_length}/normalize_beta0.5_${scorer_lr}_${scorer_grad_clip}_${normalize_hidden}_"
prefix="PromptedRWKU/Llama3.2-1B/${max_length}/pretrained_fixed_beta0.5_${num_train_epochs}_${scorer_lr}_${scorer_grad_clip}_${normalize_hidden}_"
# prefix="PromptedRWKU/Llama3.2-1B/${max_length}/pretrained_fixed_beta5_${num_train_epochs}_${scorer_lr}_${scorer_grad_clip}_${normalize_hidden}_"
...
HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=0 \
    ...
    data.forget.RWKU_train_original_prompted.args.max_length=${max_length} \
    data.retain.RWKU_train_original_prompted.args.max_length=${max_length}
