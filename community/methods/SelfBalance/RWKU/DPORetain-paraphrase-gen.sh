#!/bin/bash
# Paraphrase generation for DPORetain checkpoint.
# Usage: bash DPORetain-paraphrase-gen.sh [trial_name]  (default: trial_3_lr2_70e-05)
...
echo ""
echo "============================================"
echo " Paraphrase Generation: DPORetain"
echo "============================================"
...
HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=0 \
    ...
    paths.output_dir=$(pwd)/saves/unlearn/RWKU/Optimal/DPORetain/paraphrase_evals
