#!/bin/bash
# Paraphrase judging for DPORetain checkpoint.
# Usage: bash DPORetain-paraphrase-eval.sh [trial_name]  (default: trial_3_lr2_70e-05)
...
echo ""
echo "============================================"
echo " Paraphrase Evaluation: DPORetain"
echo "============================================"
