#!/bin/bash
# Paraphrase generation for SBSimNPO checkpoint.
# Usage: bash SBSimNPO-paraphrase-gen.sh [trial_name]  (default: trial_0)
...
echo ""
echo "============================================"
echo " Paraphrase Generation: SBSimNPO"
echo "============================================"
...
HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=0 \
    ...
    paths.output_dir=$(pwd)/saves/unlearn/RWKU/Optimal/SBSimNPO/paraphrase_evals
