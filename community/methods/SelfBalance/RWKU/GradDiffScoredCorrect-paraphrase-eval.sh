#!/bin/bash
# Paraphrase judging for GradDiffScoredCorrect checkpoint.
# Usage: bash GradDiffScoredCorrect-paraphrase-eval.sh [trial_name]  (default: trial_3_lr4_44e-06)
...
echo ""
echo "============================================"
echo " Paraphrase Evaluation: GradDiffScoredCorrect"
echo "============================================"
