#!/bin/bash
# Paraphrase generation for WGA checkpoint.
# Usage: bash WGA-paraphrase-gen.sh [trial_name]  (default: trial_0_lr1_57e-06)
...
echo ""
echo "============================================"
echo " Paraphrase Generation: WGA"
echo "============================================"
...
HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=0 \
    ...
    paths.output_dir=$(pwd)/saves/unlearn/RWKU/Optimal/WGA/paraphrase_evals
