#!/bin/bash
# Paraphrase generation for Scorer (GradDiffScored) checkpoint.
# Usage: bash Scorer-paraphrase-gen.sh [trial_name]  (default: trial_1_lr5_00e-06)
...
echo ""
echo "============================================"
echo " Paraphrase Generation: Scorer"
echo "============================================"
...
HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=0 \
    ...
    paths.output_dir=$(pwd)/saves/unlearn/RWKU/Optimal/Scorer/paraphrase_evals
