#!/bin/bash
# Paraphrase judging for NPORetain checkpoint.
# Usage: bash NPORetain-paraphrase-eval.sh [trial_name]  (default: trial_3_lr1_18e-05)
...
echo ""
echo "============================================"
echo " Paraphrase Evaluation: NPORetain"
echo "============================================"
