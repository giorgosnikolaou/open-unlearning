#!/bin/bash
# Paraphrase generation for SBDPO checkpoint.
# Usage: bash SBDPO-paraphrase-gen.sh [trial_name]  (default: trial_0)
...
echo ""
echo "============================================"
echo " Paraphrase Generation: SBDPO"
echo "============================================"
...
HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=0 \
    ...
    paths.output_dir=$(pwd)/saves/unlearn/RWKU/Optimal/SBDPO/paraphrase_evals
