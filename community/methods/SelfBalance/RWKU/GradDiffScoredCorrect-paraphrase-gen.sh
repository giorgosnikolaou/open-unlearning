#!/bin/bash
# Paraphrase generation for GradDiffScoredCorrect checkpoint.
# Usage: bash GradDiffScoredCorrect-paraphrase-gen.sh [trial_name]  (default: trial_3_lr4_44e-06)
...
echo ""
echo "============================================"
echo " Paraphrase Generation: GradDiffScoredCorrect"
echo "============================================"
...
HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=0 \
    ...
    paths.output_dir=$(pwd)/saves/unlearn/RWKU/Optimal/GradDiffScoredCorrect/paraphrase_evals
