...
prefix="LearnedRWKU/"
prefix="LearnedRWKU/Llama3.2-1B/${max_length}/beta1_${scorer_lr}_${scorer_grad_clip}_${normalize_hidden}_"
prefix="LearnedRWKU/Llama3.2-1B/${max_length}/beta5_${scorer_lr}_${scorer_grad_clip}_${normalize_hidden}_"
prefix="LearnedRWKU/Llama3.2-1B/${max_length}/beta0_${scorer_lr}_${scorer_grad_clip}_${normalize_hidden}_"
prefix="LearnedRWKU/Llama3.2-1B/${max_length}/beta0.2_${scorer_lr}_${scorer_grad_clip}_${normalize_hidden}_"
prefix="LearnedRWKU/Llama3.2-1B/${max_length}/beta0.5_${scorer_lr}_${scorer_grad_clip}_${normalize_hidden}_"
...
#     +model.tokenizer_args.token=$HF_TOKEN \
#     ++model.model_args.device_map='auto' \
#     paths.output_dir=$(pwd)/saves/unlearn/${complete_name}/rwku_evals
