#!/bin/bash
# Paraphrase generation for SBGradDiffScored checkpoint.
# Usage: bash SBGradDiffScored-paraphrase-gen.sh [trial_name]  (default: trial_8_lr1_22e-06)
...
echo ""
echo "============================================"
echo " Paraphrase Generation: SBGradDiffScored"
echo "============================================"
...
HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=0 \
    ...
    paths.output_dir=$(pwd)/saves/unlearn/RWKU/Optimal/SBGradDiffScored/paraphrase_evals