#!/bin/bash
# Paraphrase generation for SBGradDiffScoredCorrect checkpoint.
# Usage: bash SBGradDiffScoredCorrect-paraphrase-gen.sh [trial_name]  (default: trial_0_lr2_60e-06)
...
echo ""
echo "============================================"
echo " Paraphrase Generation: SBGradDiffScoredCorrect"
echo "============================================"
