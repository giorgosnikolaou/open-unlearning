#!/bin/bash
# Paraphrase generation for GradDiff checkpoint.
# Usage: bash GradDiff-paraphrase-gen.sh [trial_name]  (default: trial_1_lr1_18e-06)
...
echo ""
echo "============================================"
echo " Paraphrase Generation: GradDiff"
echo "============================================"
...
HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=0 \
    ...
    paths.output_dir=$(pwd)/saves/unlearn/RWKU/Optimal/GradDiff/paraphrase_evals
