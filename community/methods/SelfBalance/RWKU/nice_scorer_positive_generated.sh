#!/bin/bash
# SelfBalancing GradDiff + LearnedScorer — RWKU (Model-generated positive variant)
# Uses ngiorgos/RWKU-Unlearn: forget_data for forget, retain_data (neighbors) for retain.
...
prefix="NiceRWKU_PosGen/Llama3.2-1B/${max_length}/beta5_${num_train_epochs}_${scorer_lr}_${scorer_grad_clip}_${normalize_hidden}_"
# prefix="NiceRWKU_PosGen/Llama3.2-1B/${max_length}/beta1_${num_train_epochs}_${scorer_lr}_${scorer_grad_clip}_${normalize_hidden}_"
prefix="NiceRWKU_PosGen/Llama3.2-1B/${max_length}/beta0.5_${num_train_epochs}_${scorer_lr}_${scorer_grad_clip}_${normalize_hidden}_"
prefix="NiceRWKU_PosGen/Llama3.2-1B/${max_length}/pre_beta0.5_${num_train_epochs}_${scorer_lr}_${scorer_grad_clip}_${normalize_hidden}_"
prefix="NiceRWKU_PosGen/Llama3.2-1B/${max_length}/nobeta_${num_train_epochs}_${scorer_lr}_${scorer_grad_clip}_${normalize_hidden}_"
...
###################
echo "==========================================="
echo " LearnedScorer PosGen — ${complete_name}"
echo "==========================================="
...
HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=0 \
    ...
    # data.forget.RWKU_forget_positive_generated.args.max_length=${max_length} \
